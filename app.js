(function () {
    const translations = {
        th: {
            ...
            "projects.title": "โปรเจกต์<span>ของผม</span><span class=\"bg-text\">MyMiniProject</span>",
            "projects.intro": "โปรเจกต์ในโฟลเดอร์ MyMiniProject — ฝึกสร้างแอปเต็มระบบ",
            "projects.finance.title": "Ledger — รายรับรายจ่าย",
            "projects.finance.desc": "React + ASP.NET Core · Login · CRUD ผู้ใช้ · รายรับรายจ่าย + สลิป · Dashboard",
        ...
        en: {
            ...
            "projects.title": "My <span>Projects</span><span class=\"bg-text\">MyMiniProject</span>",
            "projects.intro": "Projects in MyMiniProject — full-stack practice apps",
            "projects.finance.title": "Ledger — Income & Expense",
            "projects.finance.desc": "React + ASP.NET Core · Login · User CRUD · Transactions + slips · Dashboard",
