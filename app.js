(function () {
    const translations = {
        th: {
            ...
            "extras.job.start.value": "หลัง 01/08/2569 (พ.ศ.) / 01/08/2026 (ค.ศ.) · หลังจากได้งาน 1 สัปดาห์",
            ...
            "contact.jobpref.value": "Programmer · ได้ทุกที่ · ขอนแก่น (พิเศษ) · ได้ทุกรูปแบบ · WFH (พิเศษ) · 20,000–30,000 บาท · เริ่มงานได้หลัง 01/08/2569 (พ.ศ.) / 01/08/2026 (ค.ศ.) · หลังจากได้งาน 1 สัปดาห์",
            "contact.email": "อีเมล",
