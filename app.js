(function () {
    const translations = {
        th: {
            ...
            "projects.intro": "โปรเจกต์ฝึกปฏิบัติ — Ledger เป็น SPA + REST API (MyMiniProject) และ EToon (Flutter Mobile)",
            "projects.finance.title": "Ledger — React",
            "projects.finance.desc": "SPA + REST API · React · ASP.NET Core · Login · CRUD · สลิป · Dashboard",
            "projects.angular.title": "Ledger — Angular",
            "projects.angular.desc": "SPA + REST API · Angular · ASP.NET Core · Login · CRUD · สลิป · Dashboard",
            "projects.vue.title": "Ledger — Vue",
            "projects.vue.desc": "SPA + REST API · Vue 3 · ASP.NET Core · Login · CRUD · สลิป · Dashboard",
            "projects.laravel.title": "Ledger — Laravel",
            "projects.laravel.desc": "SPA + REST API · Laravel Blade/JS · Login · CRUD · สลิป · Dashboard",
        ...
        en: {
            ...
            "projects.intro": "Practice projects — Ledger as SPA + REST API (MyMiniProject) and EToon (Flutter Mobile)",
            "projects.finance.title": "Ledger — React",
            "projects.finance.desc": "SPA + REST API · React · ASP.NET Core · Login · CRUD · slips · Dashboard",
            "projects.angular.title": "Ledger — Angular",
            "projects.angular.desc": "SPA + REST API · Angular · ASP.NET Core · Login · CRUD · slips · Dashboard",
            "projects.vue.title": "Ledger — Vue",
            "projects.vue.desc": "SPA + REST API · Vue 3 · ASP.NET Core · Login · CRUD · slips · Dashboard",
            "projects.laravel.title": "Ledger — Laravel",
            "projects.laravel.desc": "SPA + REST API · Laravel Blade/JS · Login · CRUD · slips · Dashboard",
            "projects.etoon.title": "EToon — Flutter Mobile",
